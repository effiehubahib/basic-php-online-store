...
if(!isset($_GET['day'])){
  ...
  $querySoldToday = "SELECT tbl_product.product_name as product_name,
                      ...
                      WHERE YEAR(tbl_cart.dateadded) = YEAR('".$_GET['day']."') &&
                      tbl_cart.delivery_status>2";
}
 ...
 <div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    <small>Yearly Sold Product</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="required form-group">
                  ...
                  <br/>
                  <button type="submit" name="searchYearly" id="searchYearly" class="btn btn-default button button-medium">
