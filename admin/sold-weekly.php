...
if(!isset($_GET['day'])){
  $querySoldWeekly = "SELECT tbl_product.product_name as product_name,
                      ...
                      WHERE WEEK(tbl_cart.dateadded) = WEEK(NOW()) &&
  ...
  $querySoldWeekly = "SELECT tbl_product.product_name as product_name,
                      ...
                      WHERE WEEK(tbl_cart.dateadded) = WEEK('".$_GET['day']."') &&
                      tbl_cart.delivery_status>2";
}
$resultSoldWeekly = mysqli_query($conn,$querySoldWeekly);
?>
 ...
 <div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    <small>Weekly Sold Product</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        <div class="row">
        <div class="col-lg-4">
        <form action="sold-daily.php" method="GET" id="account-creation_form" class="std box" enctype="multipart/form-data">
        ...
        <table id="table" class="table table-striped table-bordered table-hover table-order-column" cellspacing="0" width="100%">
            ...
            <tbody>
             <?php 
              while($data=mysqli_fetch_assoc($resultSoldWeekly))
              {
                echo "<tr>";
